const falhas = [{
  ...
  "Descrição": "Alarme de sobrecarga no motor.",
  "Causas Prováveis": [
...
},
 {
  ...
  "Descrição": "Alarme de sobrecarga no módulo de potência com IGBTs.",
  "Causas Prováveis": "   Corrente alta na saída do inversor."
 },
{
  "Falha": "A0050",
  "Alarme": "Temperatura Elevada no Módulo de Potência",
  "Descrição": "Alarme de temperatura elevada medida no sensor de temperatura (NTC) do módulo de potência.",
  "Causas Prováveis": [
...
,
 {
  ...
  "Descrição": "Alarme externo via DIx (opção \"Sem Alarme Externo\" em P026x).",
  "Causas Prováveis": [
...
,
 {
  ...
  "Descrição": "Alarme que indica falha na comunicação serial. Indica que o equipamento parou de receber telegramas seriais válidos por um período maior do que o programado no P0314.",
  "Causas Prováveis": [
...
,
 {
  ...
  "Descrição": "Indica que a interface CAN não possui alimentação entre os pinos 1 e 5 do conector.",
  "Causas Prováveis": [
...
,
 {
  "Falha": "A0134",
  "Alarme": "Bus Off",
  "Descrição": "Detectado erro de bus off na interface CAN.",
  "Causas Prováveis": [
...
,
 {
  ...
  "Descrição": "Controle de erros da comunicação CANopen detectou erro de comunicação utilizando o mecanismo de guarding.",
  "Causas Prováveis": [
...
,
 {
  ...
  "Descrição": "Alarme que indica que o mestre da rede DeviceNet está em modo Idle.",
  "Causas Prováveis": [
...
,
 {
  ...
  "Descrição": "Alarme que indica que uma ou mais conexões I/O DeviceNet expiraram.",
  "Causas Prováveis": [
...
,
 {
  ...
  "Descrição": "Indica que o inversor recebeu o comando do mestre da rede Profibus DP para entrar em modo clear.",
 ...
 },
 {
  ...
  "Descrição": "Indica interrupção na comunicação entre o mestre da rede Profibus DP e o inversor. A interface de comunicação Profibus DP foi para o estado offline.",
  "Causas Prováveis": [
...
,
 {
  ...
  "Descrição": "Indica erro no acesso aos dados do módulo de comunicação Profibus DP.",
  "Causas Prováveis": [
...
,
{
  ...
  "Descrição": "Sinal da entrada analógica AIx em 4 a 20 mA ou 20 a 4 mA está abaixo de 2 mA.",
  "Causas Prováveis": [
 ...
 ,
 {
  ...
  "Descrição": "Sem comunicação com HMI remota, porém não há comando ou referência de velocidade para esta fonte.",
  "Causas Prováveis": [
...
,
 {
  ...
  "Descrição": "Ocorre quando um bloco de movimento da SoftPLC (Bloco REF) é ativo e o comando de Habilita Geral do drive não está ativo.",
  "Causas Prováveis": "   Verificar se o comando de Habilita Geral do drive está ativo."
 },
 {
  "Falha": "A0704",
  "Alarme": "Dois Movim. Habilitados",
  "Descrição": "Ocorre quando 2 ou mais blocos de movimento da SoftPLC (Bloco REF) estão habilitados ao mesmo tempo.",
  "Causas Prováveis": "   Verificar lógica do programa do usuário."
 },
 {
  "Falha": "A0706",
  "Alarme": "Refer. não Progr. SPLC",
  "Descrição": "Ocorre quando um bloco de movimento da SoftPLC é habilitado e a referência de velocidade não está programada para a SoftPLC.",
 ...
 },
 {
  ...
  "Descrição": "Ocorre quando tenta-se fazer o download de Prog. SoftPLC muito extenso (maior que 8 KB)  para o inversor.",
  "Causas Prováveis": "   Extensão do Prog. SoftPLC excedeu 8 KBytes."
 },
 {
    "Falha": "F0021",
    "Alarme": "Subtensão no Barramento CC",
    "Descrição": "Falha de subtensão no circuito intermediário.",
    "Causas Prováveis": [
  ...
  },
  {
    ...
    "Descrição": "Falha de sobretensão no circuito intermediário.",
    "Causas Prováveis": [
      "Tensão de alimentação errada, confira se os dados na etiqueta do inversor estão de acordo com a rede de alimentação e o parâmetro P0296.",
  ...
  },
  {
    ...
    "Descrição": "Controle principal não consegue estabelecer o link de comunicação com o módulo Plug-in.",
    "Causas Prováveis": [
  ...
  },
  {
    ...
    "Descrição": "Falha no ajuste da resistência do estator P0409.",
    "Causas Prováveis": [
  ...
  },
 {
  ...
  "Descrição": "Falha de sobrecarga no módulo de potência com IGBTs (3 s em 1.5xInom).",
  "Causas Prováveis": "   Corrente alta na saída do inversor (>2xInom)."
 },
   {
    "Falha": "F0051",
    "Alarme": "Sobretemperatura nos IGBTs",
    "Descrição": "Falha de sobretemperatura medida no sensor de temperatura (NTC) do módulo de potência.",
    "Causas Prováveis": [
      "Temperatura ambiente ao redor do inversor alta (>50 °C) e corrente de saída elevada.",
      "Ventilador bloqueado ou defeituoso.",
      "Dissipador muito sujo, impedindo o fluxo de ar."
  ...
  },
  {
    ...
    "Descrição": "Sobrecorrente ou curto-circuito na saída, barramento CC ou resistor de frenagem.",
    "Causas Prováveis": [
  ...
  },
  {
    ...
    "Descrição": "Falha de Sobrecarga no motor (60 s em 1,5xInom).",
    "Causas Prováveis": [
  ...
  },
  {
    ...
    "Descrição": "Falha de sobrecorrente para o terra.\nObs.:\nPode ser desabilitada ajustando P0343 = 0.",
    "Causas Prováveis": [
  ...
  },
  {
    ...
    "Descrição": "Esta falha indica que o motor está com falta de fase, desconectado ou com correntes de fase desequilibradas.",
    "Causas Prováveis": [
  ...
  },
  {
    ...
    "Descrição": "Falha de sobretemperatura medida no sensor de temperatura (Triplo PTC) do motor via entrada analógica AIx ou entrada digital DIx.",
    "Causas Prováveis": [
      "Carga no eixo do motor muito alta.",
  ...
  },
  {
    ...
    "Descrição": "Falha relativa ao algoritmo de supervisão da CPU principal do inversor.",
    "Causas Prováveis": [
      "Ruído elétrico.",
  ...
  },
  {
    ...
    "Descrição": "Falha relativa ao algoritmo de identificação automática do hardware do inversor e módulo Plug-in.",
    "Causas Prováveis": [
  ...
  },
{
    ...
    "Descrição": "Falha externa via DIx (opção \"Sem Falha Externa\" em P026x).",
    "Causas Prováveis": [
      "Fiação nas entradas DI1 a DI8 aberta ou com mau contato."
    ]
  },
  {
    ...
    "Descrição": "Versão do Firmware principal difere da versão do firmware no Módulo Plug-in.",
    "Causas Prováveis": [
  ...
  },
  {
    ...
    "Descrição": "Falha no circuito de realimentação de pulsos da tensão de saída.\nObs.: pode ser desligada em P0397.",
    "Causas Prováveis": [
  ...
  },
  {
    "Falha": "F0228",
    "Alarme": "Timeout na Recepção de Telegramas",
    "Descrição": "Indica falha na comunicação serial. Indica que o equipamento parou de receber telegramas seriais válidos por um período maior do que o programado no P0314.",
    "Causas Prováveis": [
      "Verificar instalação da rede, cabo rompido ou falha/mal contato nas conexões com a rede, aterramento.",
      "Garantir que o mestre envie telegramas para o equipamento sempre em um tempo menor que o programado no P0314.",
      "Desabilitar esta função no P0314."
  ...
  },
 {
    "Falha": "F0236",
    "Alarme": "Mestre em Idle",
    "Descrição": "Esta falha indica que o mestre da rede DeviceNet está em modo Idle.",
    "Causas Prováveis": [
      "Ajuste a chave que comanda o modo de operação do mestre para execução (run) ou então o bit correspondente na palavra de configuração do software do mestre. Em caso de dúvidas, consulte a documentação do mestre em uso."
    ]
  },
  {
    "Falha": "F0237",
    "Alarme": "Timeout na Conexão DeviceNet",
    "Descrição": "Esta falha indica que uma ou mais conexões I/O DeviceNet expiraram.",
    "Causas Prováveis": [
      "Verificar o estado do mestre da rede.",
      "Verificar instalação da rede, cabo rompido ou falha/mal contato nas conexões com a rede."
    ]
  ...
  },
  {
    ...
    "Descrição": "Indica falha no acesso aos dados do módulo de comunicação Profibus DP.",
    "Causas Prováveis": [
      "Verificar se o módulo Profibus DP está corretamente encaixado.",
  ...
  },
  {
    "Falha": "F0700",
    "Alarme": "Falha na Comunicação com HMI Remota",
    "Descrição": "Sem comunicação com HMI remota, porém há comando ou referência de velocidade para esta fonte.",
    "Causas Prováveis": [
      "Verifique se a interface de comunicação com HMI está configurada corretamente no parâmetro P0312.",
      "Cabo da HMI desconectado."
    ]
